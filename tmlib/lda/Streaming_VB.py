...
class StreamingVB:
    ...
    def __init__(self, W, K, alpha, eta, conv_infer, iter_infer, beta=None):
        self._K = K
        self._W = W
        self._alpha = alpha
        self._eta = eta
